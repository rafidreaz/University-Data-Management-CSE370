...
#-------------------------------------------------------------show grade sheet------------------------------------------------------#
                                ...
                                <!--- experimental JS --->
                                <script type="text/javascript">
                                    document.getElementById("studentidIDgrade").value = getSavedValue("student_advising1id");
                                    document.getElementById("studentidID").value = getSavedValue("student_advising1id");
                                    document.getElementById("student_advising1id").value = getSavedValue("student_advising1id");    // set the value to this input
                                    document.getElementById("student_advising2id").value = getSavedValue("student_advising2id");   // set the value to this input
                                    document.getElementById("student_advising3id").value = getSavedValue("student_advising3id");    // set the value to this input
                            ...
                            <div class="col-xl-6 tm-contact-col-l mb-4">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded-0" value="Name" placeholder="Name"required name="stdName" min="0">
                                            
                                                <p></p>
                                                <b><a style="color:#34568B";>Phone</a></b>
                                                <input type="number" class="form-control rounded-0" value="880" placeholder="Phone Number"required name="stdphn" min="0" max="20000000000"pattern="\d*">

                                                <p></p>
                                                <b><a style="color:#34568B";>Gender</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Gender" required name="stdGen" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>Blood Group</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Bloodgroup" required name="stdBG" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>Nationality</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Nationality" required name="stdNation" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>User Email</a></b>
                                                <input type="email" class="form-control rounded-0" value="Insert@gmail"placeholder="Email" required name="stdEmail" min="0">                                                

                                                <p></p>
                                                <b><a style="color:#34568B";>Mailing Address</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Current Address" required name="stdCA" min="0">
                                                
                                                <p></p>
                                                <b><a style="color:#34568B";>Permanent Address</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Permanent Address" required name="stdPA" min="0"> 

                                                <p></p>
                                                <b><a style="color:#34568B";>Death Of Birth</a></b>
                                                <input type="date" class="form-control rounded-0" value="2099-12-31" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required placeholder="Date of Birth"  name="stdDOB" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>Department</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Permanent Address" required name="stdDep" min="0">                                       
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 tm-contact-col-l mb-4">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <p></p>
                                                <b><a style="color:#34568B";>Department</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Department" required name="stdDep" min="0">
...
<!--                                     <div class="form-group">
                                                <p></p>
                                                <b><a style="color:#34568B";>Name</a></b>
                                                <input type="text" class="form-control rounded-0" value="Name" placeholder="Name"required name="randomName" min="0">
                                            
                                                <p></p>
                                                <b><a style="color:#34568B";>Phone</a></b>
                                                <input type="number" class="form-control rounded-0" value="880" placeholder="Phone Number"required name="randomphn" min="0" max="20000000000"pattern="\d*">

                                                <p></p>
                                                <b><a style="color:#34568B";>Gender</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Gender" required name="randomGen" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>Blood Group</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Bloodgroup" required name="randomBG" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>Nationality</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Nationality" required name="randomNation" min="0">

                                                <p></p>
                                                <b><a style="color:#34568B";>User Email</a></b>
                                                <input type="email" class="form-control rounded-0" value="Insert@gmail"placeholder="Email" required name="randomEmail" min="0">                                                

                                                <p></p>
                                                <b><a style="color:#34568B";>Mailing Address</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Current Address" required name="randomCA" min="0">
                                                
                                                <p></p>
                                                <b><a style="color:#34568B";>Permanent Address</a></b>
                                                <input type="text" class="form-control rounded-0" value="Insert" placeholder="Permanent Address" required name="randomPA" min="0"> 
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                if($uType=="admin")
                                                                {
                                                                    ...
                                                                    echo "ID type:<a style='color:#34568B';> Admin</a>";
                                                                    echo "Unique Identification Number: <a style='color:#34568B';>$newIDinfo2</a>";
                                                                    echo "Username: <a style='color:#34568B';>$newName</a>";  
                                                                    echo "Password: <a style='color:#34568B';>$newpass</a>";
                                                                }
                                                                ...
                                                                {   
                                                                    ...
                                                                    $sql = "INSERT INTO `student_personalinfo`(`ID`) VALUES ('$newIDinfo2')";
                                                                    $result = mysqli_query($conn,$sql);
                                                                    ...
                                                                    echo "<b>Welcome to USIS!</b><br>";
                                                                    echo "ID type: <a style='color:#34568B';>Student</a><br>";
                                                                ...
                                                                {   
                                                                    ...
                                                                    $sql = "INSERT INTO `faculty_personalinfo`(`ID`) VALUES ('$newIDinfo2')";
                                                                    $result = mysqli_query($conn,$sql);
                                                                    ...
                                                                    $result = mysqli_query($conn,$sql);
                                                                    echo "<b>Welcome to USIS!</b><br>";
                                                                    echo "ID type: <a style='color:#34568B';>Faculty</a><br>";
                                                                    echo "Unique Identification Number: <a style='color:#34568B';>$newIDinfo2</a><br>";
                                                                    echo "Username: <a style='color:#34568B';>$newName</a><br>";  
                                                                    echo "Password: <a style='color:#34568B';>$newpass</a><br>";
                                                                }
                                                                ...
                                                                {   
                                                                    #id update on faculty_personalinfo;
                                                                    $sql = "INSERT INTO `admin_personalinfo`(`ID`) VALUES ('$newIDinfo2')";
                                                                    $result = mysqli_query($conn,$sql);

                                                                    #id update on faculty_careerinfo
                                                                    
                                                                    $sql = "INSERT INTO `admin_careerinfo`(`ID`, `department`, `JoiningDate`, `Designation`) VALUES ('$newIDinfo2','Undecided','2022-04-25','Admin')";
                                                                    $result = mysqli_query($conn,$sql);
